                        ...
                        return (
                            <div key={index}>
                                <h2
                                    ...
                                    {review.product.name} 리뷰 (<strong>{reviews.length}</strong>)개
                                </h2>
                                    ...
                                    <div
                                        ...
                                        <div className={"flex justify-between mb-2"}>
                                            <div className={"flex items-center gap-2"}>
                                                ...
                                                <div className={"flex"}><RenderStar rating={review.rating} /></div>
                                                <div className={"font-medium text-gray-500 text-sm"}>{maskedName}님</div>
                                            </div>
                                        ...
                                        <div className={"text-gray-700 mt-4 mb-2"}>{review.content}</div>
                                        {review.images.length > 0 && (
                                            <div className={"flex gap-2"}>
                                                {review.images.map((image, index) => (
                                                    <div
                                                        key={index}
                                                        className={"aspect-video h-20 overflow-hidden"}>
                                                        <img
                                                            src={image.url}
